...
class ScreenshotSeeder @Inject constructor(
    ...
    suspend fun seedIfEmpty() {
        ...
        sampleData.forEach { (anime, seasons) ->
            val animeId = animeDao.insert(anime)
            seasonDao.insertAll(seasons.map { it.copy(animeId = animeId) })
        }
    }
    ...
    private val sampleData = listOf(
        ...
        AnimeEntity(
            ...
            SeasonEntity(animeId = 0, malId = 21, title = "One Punch Man", episodeCount = 12, currentEpisode = 12, score = 8.50, orderIndex = 0),
            SeasonEntity(animeId = 0, malId = 30276, title = "One Punch Man Season 2", episodeCount = 12, currentEpisode = 12, score = 7.43, orderIndex = 1)
        ),
        AnimeEntity(
            title = "Death Note",
            ...
            SeasonEntity(animeId = 0, malId = 1535, title = "Death Note", episodeCount = 37, currentEpisode = 37, score = 8.62, orderIndex = 0)
        ),
        AnimeEntity(
            ...
            SeasonEntity(animeId = 0, malId = 11061, title = "Hunter x Hunter (2011)", episodeCount = 148, currentEpisode = 75, score = 9.04, orderIndex = 0)
        ),
        AnimeEntity(
            title = "Gintama",
            ...
            SeasonEntity(animeId = 0, malId = 28977, title = "Gintama°", episodeCount = 51, currentEpisode = 20, score = 9.06, orderIndex = 0)
        ),
        AnimeEntity(
            title = "Spy x Family",
            ...
            SeasonEntity(animeId = 0, malId = 50265, title = "Spy x Family", episodeCount = 12, currentEpisode = 12, score = 8.53, orderIndex = 0)
        ),
        AnimeEntity(
            ...
            SeasonEntity(animeId = 0, malId = 5114, title = "Fullmetal Alchemist: Brotherhood", episodeCount = 64, score = 9.09, orderIndex = 0)
        ),
        AnimeEntity(
            title = "Naruto",
            ...
            SeasonEntity(animeId = 0, malId = 20, title = "Naruto", episodeCount = 220, currentEpisode = 135, score = 8.0, orderIndex = 0)
        ),
        AnimeEntity(
            title = "Steins;Gate",
            ...
            SeasonEntity(animeId = 0, malId = 9253, title = "Steins;Gate", episodeCount = 24, currentEpisode = 10, score = 9.07, orderIndex = 0)
        )
    )
}
