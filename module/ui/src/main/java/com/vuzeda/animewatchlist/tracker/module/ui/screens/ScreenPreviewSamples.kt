...
internal object ScreenPreviewSamples {
    ...
    private val episodes = listOf(
        EpisodeInfo(number = 1, title = "The Journey's End", aired = "2023-09-29", isFiller = false, isRecap = false),
        EpisodeInfo(number = 2, title = "It Didn't Have to Be Magic", aired = "2023-10-06", isFiller = false, isRecap = false),
        EpisodeInfo(number = 3, title = "Killing Magic", aired = "2023-10-13", isFiller = false, isRecap = false)
    )
